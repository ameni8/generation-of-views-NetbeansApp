 ...
 * @author ameni
 */
public class DoubleUIBinding extends AbstractUIBinding {

    public DoubleUIBinding(Field field) {
    ...
    public void viewtoModel(Document model) {
        ...
        if (s == null || s.trim().isEmpty()) {
            ...
            model.setDouble(field.getName(), Double.parseDouble(s));
        }
    }
    ...
    public void modelToView(Document model) {
        ...
        ((JFXTextField) node).setText(s == null ? "" : String.valueOf(s.doubleValue()));
    }
