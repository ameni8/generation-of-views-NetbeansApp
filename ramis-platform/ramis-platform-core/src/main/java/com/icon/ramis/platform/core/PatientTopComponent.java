 ...
 */
@ConvertAsProperties(
        dtd = "-//com.icon.ramis.platform.core//Patient//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "com.icon.ramis.platform.core.PatientTopComponent")
...
@Messages({
    ...
    "CTL_PatientTopComponent=Patient Window",
    "HINT_PatientTopComponent=This is a Patient window"
})
public final class PatientTopComponent extends TopComponent {
    ...
    public void componentOpened() {
          if (fp == null) {
            fp = new JFXAppForm(com.icon.ramis.platform.core.model.Patient.class);
