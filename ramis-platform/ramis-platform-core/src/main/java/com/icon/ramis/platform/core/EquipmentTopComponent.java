 ...
 */
@ConvertAsProperties(
        dtd = "-//com.icon.ramis.platform.core//Equipment//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "EquipmentTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "explorer", openAtStartup = false)
@ActionID(category = "Window", id = "com.icon.ramis.platform.core.EquipmentTopComponent")
...
public final class EquipmentTopComponent extends TopComponent {
private JFXAppForm fp;
    public EquipmentTopComponent() {
       initComponents();
    ...
    public void componentOpened() {
        if (fp == null) {
            fp = new JFXAppForm(com.icon.ramis.platform.core.model.Equipment.class);
